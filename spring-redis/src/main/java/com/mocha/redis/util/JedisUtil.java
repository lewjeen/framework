...
/**
 * <strong>Title : JedisUtil </strong>. <br>
 * <strong>Description : redis操作封装.</strong> <br>
 * <strong>Create on : 2014年8月19日 下午3:49:26 </strong>. <br>
 * <p>
...
public class JedisUtil {
	...
	public static void init() {
		...
		if (jedisPool == null) {
			Long MaxWaitMillis = Long.parseLong(bundle
					.getString("redis.pool.maxWaitMillis"));
			int maxIdle = Integer.parseInt(bundle
					.getString("redis.pool.maxIdle"));
			int maxTotal = Integer.parseInt(bundle
					.getString("redis.pool.maxTotal"));
			int minIdle = Integer.parseInt(bundle
					.getString("redis.pool.minIdle"));
			boolean testOnBorrow = Boolean.parseBoolean(bundle
					.getString("redis.pool.testOnBorrow"));
			boolean testOnReturn = Boolean.parseBoolean(bundle
					.getString("redis.pool.testOnReturn"));
			String host = bundle.getString("redis.pool.host");
			int port = Integer.parseInt(bundle.getString("redis.pool.port"));
	...
	public class Strings {
		...
		public String set(String key, Object object) {
			...
			return set(SafeEncoder.encode(key),
					SafeEncoder.encode(JSON.toJSONString(object)));
		}
