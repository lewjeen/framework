 ...
 * the web package, reading in its configuration from context-params in
 * <code>web.xml</code>. In a J2EE web application, log4j is usually set up via
 * Log4jConfigListener or Log4jConfigServlet, delegating to Log4jWebConfigurer
 * underneath.
 * 
...
public abstract class Log4jConfigurer {
	 ...
	 * extension, and a properties file otherwise.
	 * <p>
