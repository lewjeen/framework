 ...
 * Transformers}, and the <code>javax.xml.transform</code> package in general.
 * 
 * @author Rick Evans
...
public abstract class TransformerUtils {
	 ...
	 * {@link #enableIndenting(javax.xml.transform.Transformer) indenting is
	 * enabled}.
	 * <p>
	 * Defaults to "2".
	 */
	 ...
	 * <code>indent-amount</code> will be also be set to a value of
	...
	public static void enableIndenting(Transformer transformer, int indentAmount) {
		...
		Assert.isTrue(indentAmount > -1,
				"The indent amount cannot be less than zero : got "
						+ indentAmount);
		transformer.setOutputProperty(OutputKeys.INDENT, "yes");
		try {
			// Xalan-specific, but this is the most common XSLT engine in any
			// case
