...
/**
 * Strategy interface for persisting <code>java.util.Properties</code>, allowing
 * for pluggable parsing strategies.
 * 
 * <p>
 * The default implementation is DefaultPropertiesPersister, providing the
 * native parsing of <code>java.util.Properties</code>, but allowing for reading
 * from any Reader and writing to any Writer (which allows to specify an
 * encoding for a properties file).
 * 
 * <p>
 ...
 * default implementations delegate to JDK 1.5's corresponding methods.
 * 
