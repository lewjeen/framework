...
package com.mocha.common.utils.comparator;
...
public class NullSafeComparator<T> implements Comparator<T> {
	 ...
	 * non-null objects.
	 */
	public static final NullSafeComparator NULLS_LOW = new NullSafeComparator(
			true);
	 ...
	 * non-null objects.
	 */
	public static final NullSafeComparator NULLS_HIGH = new NullSafeComparator(
			false);
