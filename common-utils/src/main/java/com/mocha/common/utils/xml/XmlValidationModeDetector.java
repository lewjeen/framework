...
public class XmlValidationModeDetector {
	 ...
	 * {@link InputStream}. Note that the supplied {@link InputStream} is closed
	 * by this method before returning.
	 * 
	 * @param inputStream
	...
	private boolean hasOpeningTag(String content) {
		...
		return (openTagIndex > -1 && content.length() > openTagIndex && Character
				.isLetter(content.charAt(openTagIndex + 1)));
	}
	...
	/**
	 * Consume the next comment token, update the "inComment" flag and return
	 ...
	 */
	private int commentToken(String line, String token,
