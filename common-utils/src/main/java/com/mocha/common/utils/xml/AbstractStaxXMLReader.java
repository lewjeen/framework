...
/**
 * Abstract base class for SAX <code>XMLReader</code> implementations that use
 * StAX as a basis.
 * 
...
abstract class AbstractStaxXMLReader extends AbstractXMLReader {
	 ...
	 * <code>http://xml.org/sax/features/namespaces</code> is turned on.
	 */
	...
	/**
	 * Indicates whether the SAX feature
	 * <code>http://xml.org/sax/features/namespaces-prefixes</code> is turned
	 * on.
	 */
	 ...
	 * <p>
	 * <b>NOTE:</b>: The given <code>InputSource</code> is not read, but
	 * ignored.
	 * 
	 * @param ignored
	 *            is ignored
	 * @throws SAXException
	 *             a SAX exception, possibly wrapping a
	 ...
	 */
	protected abstract void parseInternal() throws SAXException,
			XMLStreamException;
	...
	/**
	 * Implementation of the <code>Locator</code> interface that is based on a
	 * StAX <code>Location</code>.
	 * 
	 * @see Locator
	 * @see Location
	 */
