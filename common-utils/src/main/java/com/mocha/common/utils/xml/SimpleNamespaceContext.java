...
/**
 * Simple <code>javax.xml.namespace.NamespaceContext</code> implementation.
 * Follows the standard <code>NamespaceContext</code> contract, and is loadable
 * via a <code>java.util.Map</code> or <code>java.util.Properties</code> object
 * 
...
public class SimpleNamespaceContext implements NamespaceContext {
	...
	/**
	 * Sets the bindings for this namespace context. The supplied map must
	 * consist of string key value pairs.
	 * 
	 * @param bindings
	 *            the bindings
	 */
