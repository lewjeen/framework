...
public class Crc16Test {
	private static char[] crc_tb = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084,
	...
	public static char caluCRCObject(Object object) {
		byte[] pByte = toByteArray(object);
		int len = pByte.length;
		char crc;
		byte da;
		crc = 0x0;
